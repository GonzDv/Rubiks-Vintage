			...
			<section className='max-w-7xl mx-auto px-6 pt-32 pb-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-end'>
				...
				<div className='space-y-6 lg:pb-4'>
					<p className='text-black/60 text-base md:text-lg font-light leading-relaxed max-w-md'>
						ZÁLEA nació en Querétaro con una idea
						simple: que la joyería elegante no debería
					...
					<p className='text-black/40 text-sm font-light leading-relaxed max-w-md'>
						...
						seleccionados con criterio, para mujeres que
						quieren brillar todos los días sin
						pretensiones.
					</p>
			...
			<section className='max-w-7xl mx-auto px-6 py-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
				<div className='space-y-8'>
					...
					<div className='space-y-4 text-black/50 font-light leading-relaxed text-sm md:text-base'>
						<p>
							ZÁLEA es el proyecto de una mujer con
							ojo para lo bello y convicción en lo
							que selecciona. Cada pieza — desde
							aretes statement hasta cadenas y
							pulseras — pasa por sus manos antes de
							llegar a las tuyas.
						</p>
						<p>
							La curaduría no es casualidad. Es el
							criterio de alguien que entiende que
							la joyería no es solo adorno, es
							expresión de quién eres cada día.
						</p>
					</div>
					<a
				...
				<div className='grid grid-cols-2 gap-4'>
					{STATS.map((stat) => (
						...
						>
							...
							<p className='text-[9px] uppercase tracking-widest text-black/30 mt-2'>
								{stat.label}
							</p>
						</div>
					))}
				...
				<div className='max-w-7xl mx-auto px-6'>
					...
					<div className='grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8'>
						{VALUES.map((value) => (
							...
							>
								<span className='text-[10px] font-mono text-[#C4A95E]/50'>
									{value.number}
								</span>

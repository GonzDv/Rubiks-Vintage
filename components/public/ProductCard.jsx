...
console.log("Renderizando ProductCard con producto:", product.image_url);
  return (
    <div className="group cursor-pointer">
      {/* Contenedor de Imagen con Aspect Ratio 3:4 como en tus referencias */}
      ...
      <div className="flex justify-between items-start gap-4 px-1">
        <div>
          <h3 className="text-[11px] font-medium text-gray-900 uppercase tracking-[0.15em] leading-tight">
            {product.name}
          </h3>

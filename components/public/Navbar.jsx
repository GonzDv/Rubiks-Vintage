									...
									{user ? (
										<>
											<div className='px-4 py-3 border-b border-black/5 mb-2'>
												<p className='text-[10px] text-black/40 uppercase tracking-widest italic'>
													Bienvenida,
												</p>
											...
											{isAdmin && (
												<Link
													href='/admin'
													className='flex items-center gap-3 px-4 py-2 text-[10px] uppercase tracking-widest hover:bg-[#F5F1EB] transition-colors text-black font-bold'
												>
													<LayoutDashboard
														size={
															14
											...
											<Link
												href='/account'
												className='flex items-center gap-3 px-4 py-2 text-[10px] uppercase tracking-widest hover:bg-[#F5F1EB] transition-colors'
											>
												<Settings
													size={
														14
											...
											<button
												...
												className='w-full flex items-center gap-3 px-4 py-2 text-[10px] uppercase tracking-widest text-red-500 hover:bg-red-50 transition-colors border-t border-black/5 mt-2'
											>
												<LogOut
													size={
														14
						...
						<div className='mt-auto pt-8 border-t border-black/5 space-y-6'>
							{!user ? (
								<Link
									...
									className='flex items-center gap-4 text-[11px] uppercase tracking-[0.4em] font-bold text-black'
								>
									<User
										size={18}
										strokeWidth={1.5}
								...
								<div className='space-y-4'>
									<p className='text-[10px] uppercase tracking-[0.2em] text-black/40 font-bold italic'>
										Hola,{' '}
										{
											user
												.user_metadata
									...
									{isAdmin && (
										<Link
											...
											className='block text-[11px] uppercase tracking-[0.3em] font-bold text-[#A07F3A]'
										>
											Panel Admin
										</Link>
									)}
									<Link
										...
										className='block text-[11px] uppercase tracking-[0.3em] font-bold'
									>
										Ajustes de cuenta
									</Link>
									<button
										...
										className='text-[11px] uppercase tracking-[0.3em] font-bold text-red-500'
									>
										Cerrar Sesión
									</button>
								</div>
